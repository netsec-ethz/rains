...
func TestUpdateSectionValidity(t *testing.T) {
	...
	var tests = []struct {
		...
		sigValidSince  int64
		sigValidUntil  int64
		maxVal         util.MaxCacheValidity
		wantValidSince int64
		wantValidUntil int64
	}{
		{input: nil}, //should not result in panic
		{new(section.Assertion), now + 1, now + 4, now + 2, now + 3, util.MaxCacheValidity{AssertionValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Assertion), now + 2, now + 3, now + 1, now + 4, util.MaxCacheValidity{AssertionValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Assertion), now + 1, now + 3, now + 2, now + 4, util.MaxCacheValidity{AssertionValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Assertion), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{AssertionValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Assertion), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{AssertionValidity: 2 * time.Second}, now + 2, now + 2},
		{new(section.Assertion), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{AssertionValidity: 1 * time.Second}, now + 1, now + 1},

		{new(section.Shard), now + 1, now + 4, now + 2, now + 3, util.MaxCacheValidity{ShardValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Shard), now + 2, now + 3, now + 1, now + 4, util.MaxCacheValidity{ShardValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Shard), now + 1, now + 3, now + 2, now + 4, util.MaxCacheValidity{ShardValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Shard), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{ShardValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Shard), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{ShardValidity: 2 * time.Second}, now + 2, now + 2},
		{new(section.Shard), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{ShardValidity: 1 * time.Second}, now + 1, now + 1},

		{new(section.Zone), now + 1, now + 4, now + 2, now + 3, util.MaxCacheValidity{ZoneValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Zone), now + 2, now + 3, now + 1, now + 4, util.MaxCacheValidity{ZoneValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Zone), now + 1, now + 3, now + 2, now + 4, util.MaxCacheValidity{ZoneValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Zone), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{ZoneValidity: 4 * time.Second}, now + 2, now + 3},
		{new(section.Zone), now + 2, now + 4, now + 1, now + 3, util.MaxCacheValidity{ZoneValidity: 2 * time.Second}, now + 2, now + 2},
